            ...
            <ul class="align">
               ...
               <figure class='book'>        
                  ...
                  <figcaption>
                     ...
                     <span>العدد الأول لمجلة المتحف</span>
...
<a href="{{asset('upload/pdf/first.pdf')}}" target="_blank" style="    padding-right: 22px;">    <button type="button" class="btn btn-warning mt-0 border-0 px-3 py-2">تصفح</button>
</a>
