...
// $('.main-header .navigation>li').click(function(){
...
function eventCarousel () {
    ...
    if (owl.length) {
        owl.on({'initialized.owl.carousel': function () {owl.find('.item').show();}
        }).owlCarousel({
...
jQuery(document).on('ready', function () {
	(function ($) {
        ...
        setTimeout(function(){eventCarousel();}, 500);
        setTimeout(function(){blogCarousel();}, 500);
        blogCarouselStyle2();
        blogCarouselStyle3();
        eventCarouselstyle2();
        artCarousel();
        artCarouselStyle2();
        setTimeout(function(){testimonialCarousel();}, 500);
        exhibitionsCarousel();
